...
public class Generics {	
	    ...
	    */	
		...
		public static void imprimirArrayString(String[] elementos){
			for (int i=0; i< elementos.length; i++){
		...
		public static void main (String array[]) {
			...
			//Date[] datas = { new Date(21-02-4), new Date() };
			Generics.imprimirArrayGeneric(inteiros);
//			Genericos.imprimirArrayDouble(flutuantes);
			Generics.imprimirArrayString(strings);
		}
